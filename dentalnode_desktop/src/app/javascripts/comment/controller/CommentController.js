angular.module("dentalApp").controller('CommentController',[ '$scope', '$http', '$templateCache', '$location', '$routeParams', '$rootScope', '$modal', '$log', function($scope, $http, $templateCache, $location, $routeParams, $rootScope,  $modal, $log) {
	$scope.master = {};
	$scope.doctor = {};
	$scope.patient = {};
	$scope.comment = {};
...
/*angular.module("dentalApp").controller('ModalInstanceCtrl', function ($scope, $modalInstance, $http, $rootScope, $templateCache, items, commentList) {
