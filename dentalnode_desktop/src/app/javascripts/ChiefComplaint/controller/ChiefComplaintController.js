angular.module("dentalApp").controller('ChiefComplaintController', ['$scope', '$http', '$templateCache', '$location', '$routeParams', '$rootScope', function($scope, $http, $templateCache, $location, $routeParams, $rootScope) {
	$scope.master = {};
	$scope.patient = {};
