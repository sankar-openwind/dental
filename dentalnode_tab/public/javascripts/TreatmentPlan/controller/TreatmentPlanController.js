app.controller('TreatmentPlanController',[ '$scope', '$http', '$templateCache', '$location', '$routeParams', '$rootScope', function($scope, $http, $templateCache, $location, $routeParams, $rootScope) {
	...
	$scope.saveTreatmentPlan = function(treatmentInformation) {
		var patientId = $routeParams.patientid;
		$scope.patient.patientid = patientId;
		var method = 'POST';
		var inserturl = $rootScope.restURL+'/savetreatmentPlan';

		$scope.master = {};
		$scope.master.treatmentPlanData = angular.copy($scope.treatmentInformation);
		var patientDetails = {
			"patientId" : patientId
		}
