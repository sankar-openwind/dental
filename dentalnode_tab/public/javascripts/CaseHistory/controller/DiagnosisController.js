app.controller('DiagnosisController', ['$scope', '$http', '$templateCache', '$location', '$routeParams', '$rootScope', function($scope, $http, $templateCache, $location, $routeParams, $rootScope) {
	...
	$scope.getDiagnosisInformation = function() {
		...
		var regurl = $rootScope.restURL+'/getDiagnosisInformation/' + patientid;
		$http.get(regurl).success(function(data) {
			console.log("got the patient details " + patientid + data);
			$scope.diagnosisInformation = addSymbols(data);
	...
	$scope.saveDiagonisSummary = function(diagnosisInformation) {
		...
		var method = 'POST';
		var inserturl = $rootScope.restURL+'/saveDiagnosisInformation';
